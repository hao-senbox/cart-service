...
func (s *cartService) CheckOutCart(ctx context.Context, userID string) error {
	response, err := s.orderAPI.CreateOrderByUserID(userID)
	if err != nil {
...
func (c *callAPI) CreateOrderByUserID(userID string) (interface{}, error) {
